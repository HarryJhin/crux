...
impl TabPanel {
    ...
    /// Returns the number of panels in this tab panel.
    ...
    /// Set the active tab index, cycling the tab bar and focusing the panel.
    ...
    /// Toggle zoom state on the active panel.
    pub fn on_action_toggle_zoom(
        &mut self,
        _: &ToggleZoom,
        window: &mut Window,
        cx: &mut Context<Self>,
